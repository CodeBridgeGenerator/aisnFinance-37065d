const { FaciltyAgreement } = require("./faciltyAgreement.class");
const createModel = require("./faciltyAgreement.model");
const hooks = require("./faciltyAgreement.hooks");
...
module.exports = function (app) {
  ...
  app.use("/faciltyAgreement", new FaciltyAgreement(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("faciltyAgreement");

  // Get the schema of the collections 
  app.get("/faciltyAgreementSchema", function (request, response) {
