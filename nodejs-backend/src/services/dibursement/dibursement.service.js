const { Dibursement } = require("./dibursement.class");
const createModel = require("./dibursement.model");
const hooks = require("./dibursement.hooks");
...
module.exports = function (app) {
  ...
  app.use("/dibursement", new Dibursement(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("dibursement");

  // Get the schema of the collections 
  app.get("/dibursementSchema", function (request, response) {
