const { LegalCooridination } = require("./legalCooridination.class");
const createModel = require("./legalCooridination.model");
const hooks = require("./legalCooridination.hooks");
...
module.exports = function (app) {
  ...
  app.use("/legalCooridination", new LegalCooridination(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("legalCooridination");

  // Get the schema of the collections 
  app.get("/legalCooridinationSchema", function (request, response) {
