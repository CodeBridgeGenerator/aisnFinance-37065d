const { RicsValuation } = require("./ricsValuation.class");
const createModel = require("./ricsValuation.model");
const hooks = require("./ricsValuation.hooks");
...
module.exports = function (app) {
  ...
  app.use("/ricsValuation", new RicsValuation(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("ricsValuation");

  // Get the schema of the collections 
  app.get("/ricsValuationSchema", function (request, response) {
