const { FileAdminChecklist } = require("./fileAdminChecklist.class");
const createModel = require("./fileAdminChecklist.model");
const hooks = require("./fileAdminChecklist.hooks");
...
module.exports = function (app) {
  ...
  app.use("/fileAdminChecklist", new FileAdminChecklist(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("fileAdminChecklist");

  // Get the schema of the collections 
  app.get("/fileAdminChecklistSchema", function (request, response) {
