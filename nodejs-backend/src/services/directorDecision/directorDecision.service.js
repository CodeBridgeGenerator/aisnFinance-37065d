const { DirectorDecision } = require("./directorDecision.class");
const createModel = require("./directorDecision.model");
const hooks = require("./directorDecision.hooks");
...
module.exports = function (app) {
  ...
  app.use("/directorDecision", new DirectorDecision(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("directorDecision");

  // Get the schema of the collections 
  app.get("/directorDecisionSchema", function (request, response) {
