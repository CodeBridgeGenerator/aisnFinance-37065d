const { OfferLetter } = require("./offerLetter.class");
const createModel = require("./offerLetter.model");
const hooks = require("./offerLetter.hooks");
...
module.exports = function (app) {
  ...
  app.use("/offerLetter", new OfferLetter(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("offerLetter");

  // Get the schema of the collections 
  app.get("/offerLetterSchema", function (request, response) {
