const { CreditPaper } = require("./creditPaper.class");
const createModel = require("./creditPaper.model");
const hooks = require("./creditPaper.hooks");
...
module.exports = function (app) {
  ...
  app.use("/creditPaper", new CreditPaper(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("creditPaper");

  // Get the schema of the collections 
  app.get("/creditPaperSchema", function (request, response) {
