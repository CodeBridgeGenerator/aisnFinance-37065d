const { DueDiligence } = require("./dueDiligence.class");
const createModel = require("./dueDiligence.model");
const hooks = require("./dueDiligence.hooks");
...
module.exports = function (app) {
  ...
  app.use("/dueDiligence", new DueDiligence(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("dueDiligence");

  // Get the schema of the collections 
  app.get("/dueDiligenceSchema", function (request, response) {
