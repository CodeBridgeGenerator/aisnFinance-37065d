const { CommercialApplications } = require("./commercialApplications.class");
const createModel = require("./commercialApplications.model");
const hooks = require("./commercialApplications.hooks");
...
module.exports = function (app) {
  ...
  app.use("/commercialApplications", new CommercialApplications(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("commercialApplications");

  // Get the schema of the collections 
  app.get("/commercialApplicationsSchema", function (request, response) {
