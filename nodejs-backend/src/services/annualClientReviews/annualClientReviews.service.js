const { AnnualClientReviews } = require("./annualClientReviews.class");
const createModel = require("./annualClientReviews.model");
const hooks = require("./annualClientReviews.hooks");
...
module.exports = function (app) {
  ...
  app.use("/annualClientReviews", new AnnualClientReviews(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("annualClientReviews");

  // Get the schema of the collections 
  app.get("/annualClientReviewsSchema", function (request, response) {
