const { CompletitionStatement } = require("./completitionStatement.class");
const createModel = require("./completitionStatement.model");
const hooks = require("./completitionStatement.hooks");
...
module.exports = function (app) {
  ...
  app.use("/completitionStatement", new CompletitionStatement(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("completitionStatement");

  // Get the schema of the collections 
  app.get("/completitionStatementSchema", function (request, response) {
