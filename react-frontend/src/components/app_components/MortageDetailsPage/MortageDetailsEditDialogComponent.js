...
investmentPropertyOccupierDetails: _entity?.investmentPropertyOccupierDetails,
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="requestedLoanAmount" className="w-full mb-3 p-inputtext-sm" value={_entity?.requestedLoanAmount} onChange={(e) => setValByKey("requestedLoanAmount", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
