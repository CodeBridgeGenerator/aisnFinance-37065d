...
import seederData from "./dueDiligence.seeder.json";
...
const DueDiligenceSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(DueDiligenceSeederDialogComponent);
