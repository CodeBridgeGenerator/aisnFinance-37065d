...
import seederData from "./directorDecision.seeder.json";
...
const DirectorDecisionSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(DirectorDecisionSeederDialogComponent);
