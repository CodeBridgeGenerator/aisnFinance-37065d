...
import seederData from "./offerLetter.seeder.json";
...
const OfferLetterSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(OfferLetterSeederDialogComponent);
