...
import seederData from "./completitionStatement.seeder.json";
...
const CompletitionStatementSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CompletitionStatementSeederDialogComponent);
