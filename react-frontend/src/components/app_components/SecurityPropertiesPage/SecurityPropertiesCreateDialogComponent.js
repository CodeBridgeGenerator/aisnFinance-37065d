...
const SecurityPropertiesCreateDialogComponent = (props) => {
    ...
    useEffect(() => {
        let init  = {vacantPossessionOnCompletion: false,ownedPropertyhasOtherCharges: false};
    ...
    const onSave = async () => {
        if(!validate()) return;
        let _data = {
            applicationId: _entity?.applicationId?._id,propertyType: _entity?.propertyType,address: _entity?.address,postcode: _entity?.postcode,description: _entity?.description,tenure: _entity?.tenure,vacantPossessionOnCompletion: _entity?.vacantPossessionOnCompletion || false,leaseholdUnexpiredTermYears: _entity?.leaseholdUnexpiredTermYears,leaseholdUnexpiredTermMonths: _entity?.leaseholdUnexpiredTermMonths,leaseholdGroundRentPerAnnum: _entity?.leaseholdGroundRentPerAnnum,lettingRentalIncomePerAnnum: _entity?.lettingRentalIncomePerAnnum,lettingRentReviewDate: _entity?.lettingRentReviewDate,valuationContactName: _entity?.valuationContactName,valuationContactPhoneNo: _entity?.valuationContactPhoneNo,valuationContactEmail: _entity?.valuationContactEmail,purchasePrice: _entity?.purchasePrice,purchaseCurrentValue: _entity?.purchaseCurrentValue,purchaseDeposit: _entity?.purchaseDeposit,purchaseDepositSources: _entity?.purchaseDepositSources,purchaseOtherDepositSource: _entity?.purchaseOtherDepositSource,purchaseRepaymentDetails: _entity?.purchaseRepaymentDetails,ownedPropertyAcquiredDate: _entity?.ownedPropertyAcquiredDate,ownedPropertyPurchasePrice: _entity?.ownedPropertyPurchasePrice,ownedPropertyMostRecentValuation: _entity?.ownedPropertyMostRecentValuation,ownedPropertyValuationDate: _entity?.ownedPropertyValuationDate,ownedPropertyOutstandingMortgage: _entity?.ownedPropertyOutstandingMortgage,ownedPropertyCurrentLenderName: _entity?.ownedPropertyCurrentLenderName,ownedPropertycurrentLenderAddress: _entity?.ownedPropertycurrentLenderAddress,ownedPropertymortgageAccountNumber: _entity?.ownedPropertymortgageAccountNumber,ownedPropertyhasOtherCharges: _entity?.ownedPropertyhasOtherCharges || false,ownedPropertyotherChargesDetails: _entity?.ownedPropertyotherChargesDetails,
        ...
        const result = await client.service("securityProperties").create(_data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Create info", message: "Info Security Properties updated successfully" });
        props.onCreateResult(eagerResult.data[0]);
        } catch (error) {
            console.debug("error", error);
            setError(getSchemaValidationErrorsStrings(error) || "Failed to create");
            props.alert({ type: "error", title: "Create", message: "Failed to create in Security Properties" });
        }
        setLoading(false);
    };
    ...
    return (
        <Dialog header="Create Security Properties" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="securityProperties-create-dialog-component">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="leaseholdUnexpiredTermYears" className="w-full mb-3 p-inputtext-sm" value={_entity?.leaseholdUnexpiredTermYears} onChange={(e) => setValByKey("leaseholdUnexpiredTermYears", e.value)}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="leaseholdUnexpiredTermMonths" className="w-full mb-3 p-inputtext-sm" value={_entity?.leaseholdUnexpiredTermMonths} onChange={(e) => setValByKey("leaseholdUnexpiredTermMonths", e.value)}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="leaseholdGroundRentPerAnnum" className="w-full mb-3 p-inputtext-sm" value={_entity?.leaseholdGroundRentPerAnnum} onChange={(e) => setValByKey("leaseholdGroundRentPerAnnum", e.value)}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="lettingRentalIncomePerAnnum" className="w-full mb-3 p-inputtext-sm" value={_entity?.lettingRentalIncomePerAnnum} onChange={(e) => setValByKey("lettingRentalIncomePerAnnum", e.value)}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="purchasePrice" className="w-full mb-3 p-inputtext-sm" value={_entity?.purchasePrice} onChange={(e) => setValByKey("purchasePrice", e.value)}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="purchaseCurrentValue" className="w-full mb-3 p-inputtext-sm" value={_entity?.purchaseCurrentValue} onChange={(e) => setValByKey("purchaseCurrentValue", e.value)}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="purchaseDeposit" className="w-full mb-3 p-inputtext-sm" value={_entity?.purchaseDeposit} onChange={(e) => setValByKey("purchaseDeposit", e.value)}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="ownedPropertyPurchasePrice" className="w-full mb-3 p-inputtext-sm" value={_entity?.ownedPropertyPurchasePrice} onChange={(e) => setValByKey("ownedPropertyPurchasePrice", e.value)}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="ownedPropertyMostRecentValuation" className="w-full mb-3 p-inputtext-sm" value={_entity?.ownedPropertyMostRecentValuation} onChange={(e) => setValByKey("ownedPropertyMostRecentValuation", e.value)}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="ownedPropertyOutstandingMortgage" className="w-full mb-3 p-inputtext-sm" value={_entity?.ownedPropertyOutstandingMortgage} onChange={(e) => setValByKey("ownedPropertyOutstandingMortgage", e.value)}  />
            </span>
            <small className="p-error">
...
export default connect(mapState, mapDispatch)(SecurityPropertiesCreateDialogComponent);
