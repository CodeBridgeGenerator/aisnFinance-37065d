...
import seederData from "./faciltyAgreement.seeder.json";
...
const FaciltyAgreementSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(FaciltyAgreementSeederDialogComponent);
