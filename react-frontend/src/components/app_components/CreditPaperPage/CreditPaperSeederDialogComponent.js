...
import seederData from "./creditPaper.seeder.json";
...
const CreditPaperSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CreditPaperSeederDialogComponent);
