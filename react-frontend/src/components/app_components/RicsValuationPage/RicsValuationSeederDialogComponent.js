...
import seederData from "./ricsValuation.seeder.json";
...
const RicsValuationSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(RicsValuationSeederDialogComponent);
