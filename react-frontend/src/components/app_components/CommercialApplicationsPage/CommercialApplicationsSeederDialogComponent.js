...
import seederData from "./commercialApplications.seeder.json";
...
const CommercialApplicationsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CommercialApplicationsSeederDialogComponent);
