...
import seederData from "./annualClientReviews.seeder.json";
...
const AnnualClientReviewsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(AnnualClientReviewsSeederDialogComponent);
