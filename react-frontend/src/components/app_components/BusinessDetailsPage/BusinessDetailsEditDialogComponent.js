...
const BusinessDetailsEditDialogComponent = (props) => {
...
tradingName: _entity?.tradingName,
registeredName: _entity?.registeredName,
businessStartDate: _entity?.businessStartDate,
natureOfBusiness: _entity?.natureOfBusiness,
businessAddress: _entity?.businessAddress,
correspondenceAddress: _entity?.correspondenceAddress,
sharedMailbox: _entity?.sharedMailbox,
phone: _entity?.phone,
fax: _entity?.fax,
email: _entity?.email,
website: _entity?.website,
registeredAddress: _entity?.registeredAddress,
companyRegNo: _entity?.companyRegNo,
countryOfRegistration: _entity?.countryOfRegistration,
incorporatedDate: _entity?.incorporatedDate,
businessType: _entity?.businessType,
numPartners: _entity?.numPartners,
numDirectors: _entity?.numDirectors,
numBeneficiaries: _entity?.numBeneficiaries,
shareholders: _entity?.shareholders,
anticipatedTurnover: _entity?.anticipatedTurnover,
numEmployees: _entity?.numEmployees,
madeCva: _entity?.madeCva,
...
adverseCreditDetails: _entity?.adverseCreditDetails,
        ...
        await client.service("businessDetails").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info businessDetails updated successfully" });
    ...
    return (
        <Dialog header="Edit Business Details" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="businessDetails-edit-dialog-component">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="numPartners" className="w-full mb-3 p-inputtext-sm" value={_entity?.numPartners} onChange={(e) => setValByKey("numPartners", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="numDirectors" className="w-full mb-3 p-inputtext-sm" value={_entity?.numDirectors} onChange={(e) => setValByKey("numDirectors", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="numBeneficiaries" className="w-full mb-3 p-inputtext-sm" value={_entity?.numBeneficiaries} onChange={(e) => setValByKey("numBeneficiaries", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="shareholders" className="w-full mb-3 p-inputtext-sm" value={_entity?.shareholders} onChange={(e) => setValByKey("shareholders", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="anticipatedTurnover" className="w-full mb-3 p-inputtext-sm" value={_entity?.anticipatedTurnover} onChange={(e) => setValByKey("anticipatedTurnover", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="numEmployees" className="w-full mb-3 p-inputtext-sm" value={_entity?.numEmployees} onChange={(e) => setValByKey("numEmployees", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
export default connect(mapState, mapDispatch)(BusinessDetailsEditDialogComponent);
