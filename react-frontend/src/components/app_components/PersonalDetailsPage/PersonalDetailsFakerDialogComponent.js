...
const PersonalDetailsFakerDialogComponent = (props) => {
    ...
    const [commercialApplicationsIdIds, setcommercialApplicationsIdIds] = useState();
    ...
    useEffect(() => {
        ...
        client.service("commercialApplications")
                        ...
                        .then((data) => {
                        setcommercialApplicationsIdIds(data.data);
                        });
    ...
    const onRun = async () => {
        let fakeData = personalDetailsFakerFactory(props.user,fakerCount,commercialApplicationsIdIds);

        setLoading(true);
        const promises = fakeData.map((elem) => client.service("personalDetails").create(elem));
...
export default connect(mapState, mapDispatch)(PersonalDetailsFakerDialogComponent);
