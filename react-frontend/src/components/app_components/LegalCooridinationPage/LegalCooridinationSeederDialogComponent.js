...
import seederData from "./legalCooridination.seeder.json";
...
const LegalCooridinationSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(LegalCooridinationSeederDialogComponent);
