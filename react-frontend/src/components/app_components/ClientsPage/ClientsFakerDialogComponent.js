...
const ClientsFakerDialogComponent = (props) => {
    ...
    const [leadIdIds, setleadIdIds] = useState();
const [profileIdIds, setprofileIdIds] = useState();
    ...
    useEffect(() => {
        ...
        client.service("leads")
                        ...
                        .then((data) => {
                        setleadIdIds(data.data);
                        });
client.service("profiles")
                        .find({ query: { $select: ["_id","name"] } })
                        .then((data) => {
                        setprofileIdIds(data.data);
                        });
    ...
    const onRun = async () => {
        let fakeData = clientsFakerFactory(props.user,fakerCount,leadIdIds,profileIdIds);
