...
const DibursementEditDialogComponent = (props) => {
...
totalDeductions: _entity?.totalDeductions,
netAmountTransferred: _entity?.netAmountTransferred,
directorAapprovedAt: _entity?.directorAapprovedAt,
directorUserId: _entity?.directorUserId?._id,
fundsTransferredAt: _entity?.fundsTransferredAt,
solicitorReceivedAt: _entity?.solicitorReceivedAt,
clientSolicitorReceivedAt: _entity?.clientSolicitorReceivedAt,
clientProgressNotifiedAt: _entity?.clientProgressNotifiedAt,
...
notes: _entity?.notes,
        ...
        await client.service("dibursement").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info dibursement updated successfully" });
...
const directorUserIdOptions = directorUserId.map((elem) => ({ name: elem.name, value: elem.value }));
    ...
    return (
        <Dialog header="Edit Dibursement" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="dibursement-edit-dialog-component">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="totalDeductions" className="w-full mb-3 p-inputtext-sm" value={_entity?.totalDeductions} onChange={(e) => setValByKey("totalDeductions", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="netAmountTransferred" className="w-full mb-3 p-inputtext-sm" value={_entity?.netAmountTransferred} onChange={(e) => setValByKey("netAmountTransferred", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
export default connect(mapState, mapDispatch)(DibursementEditDialogComponent);
