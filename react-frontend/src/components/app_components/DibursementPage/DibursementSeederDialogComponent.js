...
import seederData from "./dibursement.seeder.json";
...
const DibursementSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(DibursementSeederDialogComponent);
