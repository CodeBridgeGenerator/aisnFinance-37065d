...
const FileAdminChecklistEditDialogComponent = (props) => {
...
adviserName: _entity?.adviserName,
clientNames: _entity?.clientNames,
checkedBy: _entity?.checkedBy?._id,
checkedDate: _entity?.checkedDate,
providerName: _entity?.providerName,
lenderName: _entity?.lenderName,
productName: _entity?.productName,
applicationForm: _entity?.applicationForm?._id,
applicationFormDate: _entity?.applicationFormDate,
identificationProof: _entity?.identificationProof,
identificationProofDate: _entity?.identificationProofDate,
factfindKyc: _entity?.factfindKyc,
factfindKycDate: _entity?.factfindKycDate,
loanMemorandumPreparedOnFile: _entity?.loanMemorandumPreparedOnFile,
boardSignOff: _entity?.boardSignOff,
offerLetterPreparedSent: _entity?.offerLetterPreparedSent,
offerLetterPrepared: _entity?.offerLetterPrepared,
facilityLetterPreparedChecked: _entity?.facilityLetterPreparedChecked,
valuationsInstructed: _entity?.valuationsInstructed,
valuationsInstructedDate: _entity?.valuationsInstructedDate,
solicitorInstructed: _entity?.solicitorInstructed,
loanDrawnDown: _entity?.loanDrawnDown,
postDrawdownDirectDebitAccounts: _entity?.postDrawdownDirectDebitAccounts,
propertyInsuranceLandRegistryOnFile: _entity?.propertyInsuranceLandRegistryOnFile,
notes: _entity?.notes,
status: _entity?.status,
completedByProfile: _entity?.completedByProfile?._id,
        };

        setLoading(true);
        try {
            
        await client.service("fileAdminChecklist").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info fileAdminChecklist updated successfully" });
...
const completedByProfileOptions = completedByProfile.map((elem) => ({ name: elem.name, value: elem.value }));
    ...
    return (
        <Dialog header="Edit File Admin Checklist" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="fileAdminChecklist-edit-dialog-component">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="applicationFormDate" className="w-full mb-3 p-inputtext-sm" value={_entity?.applicationFormDate} onChange={(e) => setValByKey("applicationFormDate", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="identificationProofDate" className="w-full mb-3 p-inputtext-sm" value={_entity?.identificationProofDate} onChange={(e) => setValByKey("identificationProofDate", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="factfindKycDate" className="w-full mb-3 p-inputtext-sm" value={_entity?.factfindKycDate} onChange={(e) => setValByKey("factfindKycDate", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="offerLetterPrepared" className="w-full mb-3 p-inputtext-sm" value={_entity?.offerLetterPrepared} onChange={(e) => setValByKey("offerLetterPrepared", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="valuationsInstructedDate" className="w-full mb-3 p-inputtext-sm" value={_entity?.valuationsInstructedDate} onChange={(e) => setValByKey("valuationsInstructedDate", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
export default connect(mapState, mapDispatch)(FileAdminChecklistEditDialogComponent);
