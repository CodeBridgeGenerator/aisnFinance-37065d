...
import seederData from "./fileAdminChecklist.seeder.json";
...
const FileAdminChecklistSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(FileAdminChecklistSeederDialogComponent);
