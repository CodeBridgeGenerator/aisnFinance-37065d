                ...
                },
{
                  ...
                  menuKey: "commercialApplications",
                  to: "/app/commercialApplications",
                },
{
                  icon: <Home />,
                ...
                },
{
                  icon: <Home />,
                  label: "Due Diligence",
                  menuKey: "dueDiligence",
                  to: "/app/dueDiligence",
                },
{
                  icon: <Home />,
                  label: "File Admin Checklist",
                  menuKey: "fileAdminChecklist",
                  to: "/app/fileAdminChecklist",
                },
{
                  icon: <Home />,
                  label: "Annual Client Reviews",
                  menuKey: "annualClientReviews",
                  to: "/app/annualClientReviews",
                },
{
                  icon: <Home />,
                  label: "Offer Letter",
                ...
                },
{
                  ...
                  menuKey: "ricsValuation",
                  to: "/app/ricsValuation",
                },
{
                  icon: <Home />,
                  label: "Director Decision",
                  menuKey: "directorDecision",
                  to: "/app/directorDecision",
                },
{
                  icon: <Home />,
                  label: "Credit Paper",
...
{
                  icon: <Home />,
                  label: "Facilty Agreement",
                  menuKey: "faciltyAgreement",
                  to: "/app/faciltyAgreement",
                },
{
                  icon: <Home />,
                  label: "Legal Cooridination",
                  menuKey: "legalCooridination",
                  to: "/app/legalCooridination",
                },
{
                  icon: <Home />,
                  label: "Completition Statement",
                  menuKey: "completitionStatement",
                  to: "/app/completitionStatement",
                },
{
                  icon: <Home />,
                  label: "Dibursement",
